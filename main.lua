...
menu.Size = UDim2.new(0,220,1,-45)
...
local status = createTab("Status And Server")
local localplayer = createTab("LocalPlayer")
local settingfarm = createTab("Setting Farm")
local skill = createTab("Hold and Select Skill")
local farming = createTab("Farming")
local farmBtn = Instance.new("TextButton", farming)
farmBtn.Size = UDim2.new(0,180,0,40)
farmBtn.Position = UDim2.new(0,20,0,20)
farmBtn.Text = "Auto Farm Level"
farmBtn.BackgroundColor3 = Color3.fromRGB(45,45,45)
farmBtn.TextColor3 = Color3.new(1,1,1)
Instance.new("UICorner", farmBtn)

farmBtn.MouseButton1Click:Connect(function()
    loadstring(game:HttpGet("LINK_SCRIPT_FARM"))()
end)
local stack = createTab("Stack Farming")
local other = createTab("Farming Other")
local fruit = createTab("Fruit and Raid")
local fruitBtn = Instance.new("TextButton", fruit)
fruitBtn.Size = UDim2.new(0,180,0,40)
fruitBtn.Position = UDim2.new(0,20,0,20)
fruitBtn.Text = "Auto Fruit"
fruitBtn.BackgroundColor3 = Color3.fromRGB(45,45,45)
fruitBtn.TextColor3 = Color3.new(1,1,1)
Instance.new("UICorner", fruitBtn)

fruitBtn.MouseButton1Click:Connect(function()
    loadstring(game:HttpGet("LINK_SCRIPT_FRUIT"))()
end)
local sea = createTab("Sea Event")
local race = createTab("Upgrade Race")
local items = createTab("Get and Upgrade Items")
local volcano = createTab("Volcano Event")
local esp = createTab("ESP")
local espBtn = Instance.new("TextButton", esp)
...
espBtn.MouseButton1Click:Connect(function()
    loadstring(game:HttpGet("LINK_SCRIPT_ESP"))()
end)
...
Tabs.Info:AddButton({
    ["Title"] = "HYUN Script | Community",
    ["Description"] = "Discord",
    ["Callback"] = function()
        setclipboard(tostring("https://discord.gg/FarEjaQg"))
    end
})
Tabs.Info:AddButton({
    ["Title"] = "Youtube",
